...
The absolutive case marks a noun or noun phrase that serves as the subject of an intransitive verb. This means that when a verb has only a single argument, that argument will by default be in the absolutive case.

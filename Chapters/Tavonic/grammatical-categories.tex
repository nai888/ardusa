...
\ex<ex:tvk-noun-gen-roles>
	\begingl
		\glpreamble\fw{Mos botra mok fra.}\\
		\phnm{mos bot\pstrs ra mok \pstrs fra}//
		\gla ∅= mos botra mok fr-a//
		\glb \An.\Sg.\Abs= \Fps.\Gen{} wife \Fps.\Dat{} see-\Ind.\Npst.\Ipfv//
		\glft\defn{My wife sees me.}//
	\endgl
\xe
...
\pex<ex:tvk-noun-gen>
	\a<ergacc>\begingl
		\glpreamble\fw{Do tesar oko tu mos ablu okotaða!}\\
		\phnm{do te\pstrs sar o\pstrs ko tu mos ab\pstrs lu o.ko\pstrs ta.ða}//
		\gla do= tesar oko tu= mos ablu okot-aða//
		\glb \An.\Sg.\Erg= \Spc.\Gen{} dog \An.\Sg.\Acc= \Fps.\Gen{} cat chase-\Ind.\Pst.\Prg//
		\glft\defn{Your dog was chasing my cat!}//
	\endgl
	\a<dat>\begingl
		\glpreamble\fw{Mod ti ennis ke tes oko ǧira.}\\
		\phnm{mod ti e\pstrs\gem{n}is ke tes o\pstrs ko ɣi\pstrs ra}//
...
\pex<ex:tvk-noun-gen-cause>
	\a<oveli>\begingl
		\glpreamble\fw{Sur su šus botrašut li puzaða arke ove.}\\
		\phnm{sur su ʃus bot.ra\pstrs ʃut li pu\pstrs za.ða ar\pstrs ke o\pstrs ve}//
...
\afterpage{\clearpage
	\begin{table}\centering
		...
		\begin{tabu}{| l | l | l l l |}
			\toprule
			\rowfont[c]\bfseries Person & Case & \Sg & \Pc & \Pl\\
			\midrule
			\multirow{9}{*}{\textbf{\Fp}} & \textbf{\Abs} & \fw{mor} & \fw{morsa} & \fw{morna}\\
			 & \textbf{\Erg} & \fw{mod} & \fw{modas} & \fw{modin}\\
			 & \textbf{\Acc} & \fw{mot} & \fw{motos} & \fw{moton}\\
			 & \textbf{\Dat} & \fw{mok} & \fw{mokas} & \fw{moken}\\
			 & \textbf{\Gen} & \fw{mos} & \fw{mosar} & \fw{mosan}\\
			\cline{2-5}
			 & \textbf{\Top} & \fw{mon} & \fw{monsa} & \fw{mana}\\
			 & \textbf{\Top.\Acc} & \fw{montu} & \fw{monsut} & \fw{manut}\\
			 & \textbf{\Top.\Dat} & \fw{monke} & \fw{monsek} & \fw{manek}\\
			 & \textbf{\Top.\Gen} & \fw{monsu} & \fw{monsus} & \fw{manus}\\
			\bottomrule
		\end{tabu}
	\end{table}
}

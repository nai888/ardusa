...
\pex<ex:tvk-rel-pronoun>
	\a<rtrv>\begingl
		\glpreamble\scr{Do ke arb frak put ǩalo ti ennis ǧirak.}\\
		\fw{Do ke arb frak put ǩalo ti ennis ǧirak.}\\
		\phnm{do ke \pstrs arb \pstrs frak put xa\pstrs lo ti en\pstrs nis ɣi\pstrs rak}//
		\gla do= ke= arb fr-ak ∅= put ǩalo ti= ennis ǧir-ak//
		\glb \An.\Sg.\Erg= \An.\Sg.\Dat= bird see-\Ind.\Pst.\Pfv{} \An.\Sg.\Abs= \Rel.\Rtrv{} man \In.\Sg.\Acc= ball throw-\Ind.\Pst.\Pfv//
		\glft\defn{The man who saw the bird threw the ball.}//
	\endgl
	\a<nrtrv>\begingl
		\glpreamble\scr{Do ke arb frak bas ǩalo ti ennis ǧirak.}\\
		\fw{Do ke arb frak bas ǩalo ti ennis ǧirak.}\\
		\phnm{do ke \pstrs arb \pstrs frak bas xa\pstrs lo ti en\pstrs nis ɣi\pstrs rak}//
		\gla do= ke= arb fr-ak ∅= bas ǩalo ti= ennis ǧir-ak//
		\glb \An.\Sg.\Erg= \An.\Sg.\Dat= bird see-\Ind.\Pst.\Pfv{} \An.\Sg.\Abs= \Rel.\Nrtrv{} man \In.\Sg.\Acc= ball throw-\Ind.\Pst.\Pfv//
		\glft\defn{The man, who saw the bird, threw the ball.}//
	\endgl
\xe
...
The relative pronoun declines to show the case of the referent within the subordinate clause. In examples~\getfullref{ex:tvk-rel-pronoun.rtrv}–\getref{ex:tvk-rel-pronoun.nrtrv}, the relative pronoun is declined to the absolutive because \defn{man} is the actor within the subordinate clause, the one seeing the bird.

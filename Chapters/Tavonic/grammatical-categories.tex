...
\pex<ex:tvk-dem-pronoun>
	\a<prox>\begingl
		...
		\gla mor ǩo= ðle us-u//
		\glb \Fps.\An.\Abs{} \In.\Sg.\Dat= this have-\Ind.\Npst.\Ipfv//
	...
	\a<medi>\begingl
		...
		\gla mor ǩo= þro us-u//
		\glb \Fps.\An.\Abs{} \In.\Sg.\Dat= that have-\Ind.\Npst.\Ipfv//
		\glft\defn{I have that (nearby).}//
	\endgl
	\a<dist>\begingl
		...
		\glb \Fps.\An.\Abs{} \In.\Sg.\Dat= that have-\Ind.\Npst.\Ipfv//
		\glft\defn{I have that (far away).}//
	\endgl
\xe

These same demonstratives can also be used as determiners by pairing them with a noun. In this situation, the determiner is behaving much like an adjective, though these terms lack the flexivity of adjectives and do not inflect to match the gender of the referent noun.

...
Lerk \phnm{\pstrs lerk}

Mollur \phnm{mo\pstrs\gem{l}ur}
...
Blimva \phnm{blim\pstrs va}

Goltu \phnm{gol\pstrs tu}

Tlunda \phnm{tlun\pstrs da}

Zarsa \phnm{zar\pstrs sa}

\subsection{Gender-Neutral Names}
\label{subsec:tvk-names-neut}

Erme \phnm{er\pstrs me}

Inki \phnm{in\pstrs ki}

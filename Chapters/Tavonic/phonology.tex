...
\index[tavonic]{consonants|(}

\afterpage{\clearpage
	\begin{sidewaystable}
		\scriptsize
		\index[tavonic]{consonants!inventory}\index[tavonic]{allophony}\index[tavonic]{consonants!allophones|see {allophony}}
	...
	\end{sidewaystable}
	\clearpage
	\index[tavonic]{consonants!romanization}
...
Despite its \enquote{average} inventory of consonants, there are many more allophones\index[tavonic]{allophony} that occur in the language. First, any doubled consonant is realized as a geminated\index[tavonic]{consonants!gemination} (elongated) consonant.
...
The remaining allophones\index[tavonic]{allophony} occur due to various sound change processes, mostly by assimilation. For example, \phnm{n} becomes velarized\index[tavonic]{consonants!velarization} when it appears immediately before a velar consonant.
...
\afterpage{\clearpage
	\begin{table}\centering
		\index[tavonic]{vowels!inventory}

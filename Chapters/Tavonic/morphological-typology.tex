...
\pex<ex:tvk-flex-verbs>
	\a<cl1>\begingl
		\glpreamble\fw{bruþatali} (class I)\\
		\phnm{bru.θa\pstrs ta.li}//
		\gla bruþat -ali//
		\glb handle -\Inf//
		\glft \defn{to handle}//
	\endgl
	\a<cl2>\begingl
		\glpreamble\fw{šeli} (class II)\\
		\phnm{\pstrs še.li}//
		\gla š -eli//
		\glb run -\Inf//
		\glft \defn{to run}//
	\endgl
	\a<cl3>\begingl
		\glpreamble\fw{teguli} (class III)\\
		\phnm{te\pstrs gu.li}//
		\gla teg -uli//
		\glb worry -\Inf//
		\glft \defn{to worry}//
...
\pex<ex:tvk-flex-verbs>
	\a<cl1>\begingl
		\glpreamble\fw{bruþatabe} (class I)\\
		\phnm{bru.θa\pstrs ta.be}//
		\gla bruþat -abe//
		\glb handle -\Act.\Ptcp//
		\glft \defn{handling}//
	\endgl
	\a<cl2>\begingl
		\glpreamble\fw{šiba} (class II)\\
		\phnm{\pstrs ši.ba}//
		\gla š -iba//
		\glb run -\Act.\Ptcp//
		\glft \defn{running}//
	\endgl
	\a<cl3>\begingl
		\glpreamble\fw{tegube} (class III)\\
		\phnm{te\pstrs gu.be}//
		\gla teg -ube//
		\glb worry -\Act.\Ptcp//
		\glft \defn{worrying}//

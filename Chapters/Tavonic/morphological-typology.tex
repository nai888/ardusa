...
\pex<ex:tvk-iso-nouns>
	...
	\a<phrase>\begingl
		...
		\phnm{e.so\pstrs kon mo\sstrs θes el\pstrs bi \pstrs ʃus ken bot\pstrs ɾa \pstrs dɾaʃ}//
...
\pex<ex:tvk-flex-adjectives>
	...
	\a<inanimate>\begingl
		...
		\phnm{ʃo fran\pstrs do e\pstrs ðeɾ}//
		\gla šo= frando eðer//
...
\pex<ex:tvk-verbs-sfxs>
	\a<i:ipr>\begingl
		...
		\phnm{ʃo\pstrs na git ak\pstrs ɾaɣ}//
		\gla šona git akr-aǧ//
	...
	\a<i:imp>\begingl
		...
		\phnm{mi \pstrs θro ak.ɾoɹ\pstrs gan.ta}//
...
\pex<ex:tvk-adjective-sfxs>
	\a<ae>\fw{ablunga} \phnm{ab.luŋ\pstrs ga} \gloss{\An} vs. \fw{ablunge} \phnm{ab.luŋ\pstrs ge} \gloss{\In} \defn{catlike}
	\a<io>\fw{akrandi} \phnm{ak.ɾan\pstrs di} \gloss{\An} vs. \fw{akrando} \phnm{ak.ɾan\pstrs do} \gloss{\In} \defn{writable}
	\a<ao>\fw{bruþatla} \phnm{bɾu.θat\pstrs la} \gloss{\An} vs. \fw{bruþatlo} \phnm{bɾu.θat\pstrs lo} \gloss{\In} \defn{manual}
	\a<uo>\fw{fraþru} \phnm{fɾaθ\pstrs ɾu} \gloss{\An} vs. \fw{fraþro} \phnm{fɾaθ\pstrs ɾo} \gloss{\In} \defn{observant}
\xe

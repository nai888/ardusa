...
%\newleipzig{subj}{sbjv}{subjunctive}% Already defined
...
\renewleipzig{prf}{prf}{perfective}% Already defined as perfect
...
\input{./Chapters/Tavonic/ethnography.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/phonology.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/morphological-typology.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/morphology.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/compounding.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/time-measurement.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/derivation.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/syntax.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/discourse.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/tvk-reference-grammar.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/ank-reference-grammar.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/rdk-reference-grammar.tex}
...
\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Appendices/conceptual-metaphors.tex}

\excnt=1% Reset the numbering of examples to 1
\chapter{Kinship}
%\input{./Chapters/Appendices/kinship.tex}

\excnt=1% Reset the numbering of examples to 1
\chapter{Names}
%\input{./Chapters/Appendices/names.tex}
...
\excnt=1% Reset the numbering of examples to 1
\chapter{Vocabulary}
%\input{./Chapters/Appendices/vocabulary.tex}

...
\newindex[Tavonic]{tavonic}
\newindex[Alnuric]{alnuric}
\newindex[Redodhic]{redodhic}
\newindex[Kalaakan]{kalaakan}
\newindex[Elvish]{elvish}
\newindex[Dwarvish]{dwarvish}
\newindex[Orcish]{orcish}
\newindex[Kunmian]{kunmian}
\newindex[Gnomish]{gnomish}

...
\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/compounding}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/time-measurement}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/derivation}
...
\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/Tavonic/tvk-reference-grammar}

...
\newcommand{\nlangrdk}{Redoðik}
\title{Ardusa}
\newcommand{\subtitle}{A Grammar of the Ardusan Languages}
\author{Ian A.~Cook}
\date{\today}
...
% I don't think we need this chapter, at least for now
% \excnt=1% Reset the numbering of examples to 1
% \input{./Chapters/morphological-typology.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/morphology.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/compounding-incorporation.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/time-measurement.tex}
...
\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/discourse.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/reference-grammar.tex}
...
\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/conceptual-metaphors.tex}

\excnt=1% Reset the numbering of examples to 1
\input{./Chapters/kinship.tex}
